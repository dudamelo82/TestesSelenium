...
import java.net.URL;
public class CT02LoginIncorretoCalcSAJTest {
  ...
  @Test
  public void cT02LoginIncorretoCalcSAJ() {
    // Test name: CT02 LoginIncorretoCalcSAJ
    ...
    // 3 | type | id=password | 12345+ | 
    driver.findElement(By.id("password")).sendKeys("12345+");
    // 4 | sendKeys | id=password | ${KEY_ENTER} | 
